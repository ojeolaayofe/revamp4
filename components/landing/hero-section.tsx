    ...
    <section className="min-h-[600px] bg-gradient-to-br from-background via-muted to-background flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
        ...
        <h1
          ...
          style={{ animationDelay: "0.1s" }}
        >
          Seamless Access to Nigerian & Global Stocks and Bonds  — From Anywhere. <span className="text-primary animate-glow">Fast, Simple & Secure</span>
        </h1>
...
Deposit Naira in Nigeria or USD from abroad, earn competitive yield, withdraw rewards or invest in Nigerian stocks — all on one secure platform.
